...
public:
    ...
    static AFcontinent continent(QString name);
    static AFcontinent continent(Enum type);
...
private:
    ...
    struct TypeStruct {
        ...
        QString m_full;
        QString m_short;
        AFcontinent m_continent;
    };

    QList <TypeStruct> m_list;

    void add(Enum type, QString full, QString short_, AFcontinent continent = AFcontinent::None);
